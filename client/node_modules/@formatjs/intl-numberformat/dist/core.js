...
var currencyDigitsData = require("./data/currency-digits.json");
var numbering_systems_json_1 = require("./data/numbering-systems.json");
var format_to_parts_1 = require("./format_to_parts");
// eslint-disable-next-line import/no-cycle
var get_internal_slots_1 = require("./get_internal_slots");
var VALID_NUMBERING_SYSTEM_NAMES = new Set(numbering_systems_json_1.names);
...
function currencyDigits(c) {
    return intl_utils_1.hasOwnProperty(currencyDigitsData, c)
...
function initializeNumberFormat(nf, locales, opts) {
    ...
    var localeData = exports.NumberFormat.localeData;
    var r = intl_utils_1.createResolveLocale(exports.NumberFormat.getDefaultLocale)(exports.NumberFormat.availableLocales, requestedLocales, opt, 
    // [[RelevantExtensionKeys]] slot, which is a constant
    ['nu'], localeData);
    var dataLocaleData = localeData[removeUnicodeExtensionFromLocale(r.locale)];
    var internalSlots = get_internal_slots_1.default(nf);
    ...
    intl_utils_1.setNumberFormatDigitOptions(internalSlots, options, mnfdDefault, mxfdDefault, notation);
...
function partitionNumberPattern(numberFormat, x) {
    var _a;
    var internalSlots = get_internal_slots_1.default(numberFormat);
    ...
    if (isNaN(x)) {
        ...
        var formatNumberResult = intl_utils_1.formatNumericToString(internalSlots, x);
...
intl_utils_1.defineProperty(exports.NumberFormat.prototype, 'formatToParts', {
    value: function formatToParts(x) {
        return formatNumericToParts(this, toNumeric(x));
    },
});
intl_utils_1.defineProperty(exports.NumberFormat.prototype, 'resolvedOptions', {
...
// Static properties
intl_utils_1.defineProperty(exports.NumberFormat, 'supportedLocalesOf', {
    value: function supportedLocalesOf(locales, options) {
        return intl_utils_1.supportedLocales(exports.NumberFormat.availableLocales, Intl.getCanonicalLocales(locales), options);
    },
});
exports.NumberFormat.__addLocaleData = function __addLocaleData() {
    ...
    for (var _a = 0, data_1 = data; _a < data_1.length; _a++) {
        ...
        for (var _b = 0, availableLocales_1 = availableLocales; _b < availableLocales_1.length; _b++) {
            ...
            try {
                exports.NumberFormat.localeData[locale] = intl_utils_1.unpackData(locale, datum);
            }
            catch (e) {
...
function setNumberFormatUnitOptions(nf, options) {
    ...
    if (unit !== undefined && !intl_utils_1.isWellFormedUnitIdentifier(unit)) {
...
function computeExponent(numberFormat, x) {
    ...
    var magnitude = intl_utils_1.getMagnitude(x);
    var exponent = computeExponentForMagnitude(numberFormat, magnitude);
    // Preserve more precision by doing multiplication when exponent is negative.
    x = exponent < 0 ? x * Math.pow(10, -exponent) : x / Math.pow(10, exponent);
    var formatNumberResult = intl_utils_1.formatNumericToString(get_internal_slots_1.default(numberFormat), x);
    if (formatNumberResult.roundedNumber === 0) {
        return [exponent, magnitude];
    }
    var newMagnitude = intl_utils_1.getMagnitude(formatNumberResult.roundedNumber);
