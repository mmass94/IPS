(function (factory) {
    ...
    */
    ...
    function formatToParts(numberResult, data, pl, options) {
        ...
        if (!compactNumberPattern) {
            ...
            if (style === 'decimal' ||
                ...
                const currencyData = data.numbers.currency[numberingSystem] ||
                ...
                // percent
                const percentPattern = data.numbers.percent[numberingSystem] ||
        ...
        const numberParts = [];
        const symbols = data.numbers.symbols[numberingSystem] ||
        ...
        for (const part of numberPatternParts) {
            ...
            switch (part) {
                case '{0}': {
                    ...
                    numberParts.push(...paritionNumberIntoParts(symbols, numberResult, notation, exponent, numberingSystem, 
        ...
        switch (style) {
            case 'currency': {
                ...
                if (options.currencyDisplay === 'name') {
                    const unitPattern = (data.numbers.currency[numberingSystem] ||
            ...
            case 'unit': {
                ...
                if (unitData) {
                    ...
                    const numeratorUnitPattern = selectPlural(pl, numberResult.roundedNumber, data.units.simple[numeratorUnit][unitDisplay]);
    ...
    function paritionNumberIntoParts(symbols, numberResult, notation, exponent, numberingSystem, useGrouping) {
        ...
        const digitReplacementTable = digitMapping$1[numberingSystem];
    ...
    function getCompactDisplayPattern(numberResult, pl, data, style, compactDisplay, currencyDisplay, numberingSystem) {
        ...
        const magnitudeKey = String(Math.pow(10, magnitude));
        const defaultNumberingSystem = data.numbers.nu[0];
        let pattern;
        if (style === 'currency' && currencyDisplay !== 'name') {
            const byNumberingSystem = data.numbers.currency;
            const currencyData = byNumberingSystem[numberingSystem] ||
                byNumberingSystem[defaultNumberingSystem];
            // NOTE: compact notation ignores currencySign!
            const compactPluralRules = (_a = currencyData.short) === null || _a === void 0 ? void 0 : _a[magnitudeKey];
            ...
            const byCompactDisplay = byNumberingSystem[numberingSystem] ||
                byNumberingSystem[defaultNumberingSystem];
    ...
    const VALID_NUMBERING_SYSTEM_NAMES = new Set(names);
    ...
    function initializeNumberFormat(nf, locales, opts) {
        ...
        const r = createResolveLocale(NumberFormat.getDefaultLocale)(NumberFormat.availableLocales, requestedLocales, opt, 
    ...
    function partitionNumberPattern(numberFormat, x) {
        ...
        const symbols = dataLocaleData.numbers.symbols[numberingSystem] ||
    ...
    function computeExponent(numberFormat, x) {
        ...
        // Preserve more precision by doing multiplication when exponent is negative.
        x = exponent < 0 ? x * Math.pow(10, -exponent) : x / Math.pow(10, exponent);
        const formatNumberResult = formatNumericToString(getInternalSlots(numberFormat), x);
    ...
    function computeExponentForMagnitude(numberFormat, magnitude) {
        ...
        switch (notation) {
            ...
            default: {
                ...
                let thresholdMap;
                if (style === 'currency' && currencyDisplay !== 'name') {
                    const currency = dataLocaleData.numbers.currency[numberingSystem] ||
                        dataLocaleData.numbers.currency[dataLocaleData.numbers.nu[0]];
                    thresholdMap = currency.short;
                }
                else {
                    const decimal = dataLocaleData.numbers.decimal[numberingSystem] ||
    ...
    var parser_1 = parser.SEPARATOR;
    var parser_2 = parser.isUnicodeLanguageSubtag;
    var parser_3 = parser.isStructurallyValidLanguageTag;
    var parser_4 = parser.isUnicodeRegionSubtag;
    var parser_5 = parser.isUnicodeScriptSubtag;
    var parser_6 = parser.isUnicodeVariantSubtag;
    var parser_7 = parser.parseUnicodeLanguageId;
    var parser_8 = parser.parseUnicodeLocaleId;
    ...
    var likelySubtags$1 = /*#__PURE__*/Object.freeze({
        __proto__: null,
        supplemental: supplemental,
        'default': likelySubtags
    });

    var likelySubtags$2 = getCjsExportFromNamespace(likelySubtags$1);

    var canonicalizer = createCommonjsModule(function (module, exports) {
    var __spreadArrays = (commonjsGlobal && commonjsGlobal.__spreadArrays) || function () {
        for (var s = 0, i = 0, il = arguments.length; i < il; i++) s += arguments[i].length;
        for (var r = Array(s), k = 0, i = 0; i < il; i++)
            for (var a = arguments[i], j = 0, jl = a.length; j < jl; j++, k++)
    ...
    function canonicalizeUnicodeLanguageId(unicodeLanguageId) {
        ...
        if (unicodeLanguageId.variants.length) {
            ...
            for (var _i = 0, _a = unicodeLanguageId.variants; _i < _a.length; _i++) {
                var variant = _a[_i];
                if ((replacedLang_1 =
                    aliases.languageAlias[emitter.emitUnicodeLanguageId({
                        lang: unicodeLanguageId.lang,
                        variants: [variant],
                    })])) {
                    var replacedLangAst = parser.parseUnicodeLanguageId(replacedLang_1.split(parser.SEPARATOR));
                    finalLangAst = {
        ...
        if (finalLangAst.script && finalLangAst.region) {
            var replacedLang_2 = aliases.languageAlias[emitter.emitUnicodeLanguageId({
            ...
            if (replacedLang_2) {
                var replacedLangAst = parser.parseUnicodeLanguageId(replacedLang_2.split(parser.SEPARATOR));
                finalLangAst = {
                    lang: replacedLangAst.lang,
        ...
        if (finalLangAst.region) {
            var replacedLang_3 = aliases.languageAlias[emitter.emitUnicodeLanguageId({
                lang: finalLangAst.lang,
                region: finalLangAst.region,
                variants: [],
            })];
            if (replacedLang_3) {
                var replacedLangAst = parser.parseUnicodeLanguageId(replacedLang_3.split(parser.SEPARATOR));
                finalLangAst = {
                    lang: replacedLangAst.lang,
                    script: finalLangAst.script || replacedLangAst.script,
                    region: replacedLangAst.region,
        ...
        // only language
        // e.g. twi -> ak
        var replacedLang = aliases.languageAlias[emitter.emitUnicodeLanguageId({
            lang: finalLangAst.lang,
            variants: [],
        })];
        if (replacedLang) {
            var replacedLangAst = parser.parseUnicodeLanguageId(replacedLang.split(parser.SEPARATOR));
            finalLangAst = {
                lang: replacedLangAst.lang,
                script: finalLangAst.script || replacedLangAst.script,
                region: finalLangAst.region || replacedLangAst.region,
        ...
        if (finalLangAst.region) {
            ...
            var regionAlias = aliases.territoryAlias[region];
            var replacedRegion = void 0;
            if (regionAlias) {
                var regions = regionAlias.split(' ');
                replacedRegion = regions[0];
                var likelySubtag = likelySubtags$2.supplemental.likelySubtags[emitter.emitUnicodeLanguageId({
                    lang: finalLangAst.lang,
                    script: finalLangAst.script,
                    variants: [],
                })];
                if (likelySubtag) {
                    var likelyRegion = parser.parseUnicodeLanguageId(likelySubtag.split(parser.SEPARATOR)).region;
        ...
        if (finalLangAst.script) {
            ...
            if (aliases.scriptAlias[finalLangAst.script]) {
                finalLangAst.script = aliases.scriptAlias[finalLangAst.script];
            }
        }
        if (finalLangAst.variants.length) {
            for (var i = 0; i < finalLangAst.variants.length; i++) {
                var variant = finalLangAst.variants[i].toLowerCase();
                if (aliases.variantAlias[variant]) {
                    var alias = aliases.variantAlias[variant];
                    if (parser.isUnicodeVariantSubtag(alias)) {
                        finalLangAst.variants[i] = alias;
                    }
                    else if (parser.isUnicodeLanguageSubtag(alias)) {
    ...
    unwrapExports(canonicalizer);
    var canonicalizer_1 = canonicalizer.canonicalizeUnicodeLanguageId;
    var canonicalizer_2 = canonicalizer.canonicalizeUnicodeLocaleId;
    ...
    function canonicalizeLocaleList(locales) {
        ...
        for (var _i = 0, locales_1 = locales; _i < locales_1.length; _i++) {
            ...
            var canonicalizedTag = emitter.emitUnicodeLocaleId(canonicalizer.canonicalizeUnicodeLocaleId(parser.parseUnicodeLocaleId(locale)));
    ...
    var parser_2 = parser;
    exports.parseUnicodeLocaleId = parser_2.parseUnicodeLocaleId;
    exports.parseUnicodeLanguageId = parser_2.parseUnicodeLanguageId;
    exports.isStructurallyValidLanguageTag = parser_2.isStructurallyValidLanguageTag;
    exports.isUnicodeRegionSubtag = parser_2.isUnicodeRegionSubtag;
    exports.isUnicodeScriptSubtag = parser_2.isUnicodeScriptSubtag;
    exports.isUnicodeLanguageSubtag = parser_2.isUnicodeLanguageSubtag;
    __export(emitter);

    });

    unwrapExports(dist);
    var dist_1 = dist.getCanonicalLocales;
    var dist_2 = dist.parseUnicodeLocaleId;
    var dist_3 = dist.parseUnicodeLanguageId;
    var dist_4 = dist.isStructurallyValidLanguageTag;
    var dist_5 = dist.isUnicodeRegionSubtag;
    var dist_6 = dist.isUnicodeScriptSubtag;
    var dist_7 = dist.isUnicodeLanguageSubtag;
    ...
    if (!('getCanonicalLocales' in Intl) ||
        ...
        Object.defineProperty(Intl, 'getCanonicalLocales', {
            value: dist.getCanonicalLocales,
            writable: true,
            enumerable: false,
            configurable: true,
        });
