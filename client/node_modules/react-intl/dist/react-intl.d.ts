...
declare interface DateTimeFormatOptions extends Intl.DateTimeFormatOptions {
...
export declare type FormatDateOptions = Exclude<DateTimeFormatOptions, 'localeMatcher'> & CustomFormatConfig;
...
export declare const FormattedDate: React_2.FC<DateTimeFormatOptions & CustomFormatConfig & {
...
export declare const FormattedNumber: React_2.FC<NumberFormatOptions & CustomFormatConfig & {
    value: number;
}>;
...
export declare const FormattedPlural: React_2.FC<WithIntlProps<Props_2>> & {
...
export declare const FormattedTime: React_2.FC<DateTimeFormatOptions & CustomFormatConfig & {
    value: string | number | Date | undefined;
}>;
...
export declare class IntlProvider extends React_2.PureComponent<React_2.PropsWithChildren<OptionalIntlConfig>, State> {
    static displayName: string;
