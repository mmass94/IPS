(function (factory) {
    ...
    class DisplayNames {
        constructor(locales, options = Object.create(null)) {
            ...
            const r = createResolveLocale(DisplayNames.getDefaultLocale)(DisplayNames.availableLocales, requestedLocales, { localeMatcher: matcher }, [], // there is no relevantExtensionKeys
            DisplayNames.localeData);
            const style = getOption(options, 'style', 'string', ['narrow', 'short', 'long'], 'long');
            setSlot(this, 'style', style);
            const type = getOption(options, 'type', 'string', ['language', 'currency', 'region', 'script'], 'language');
        ...
        resolvedOptions() {
            ...
            return Object.assign({}, getMultiInternalSlots(__INTERNAL_SLOT_MAP__, this, 'locale', 'style', 'type', 'fallback'));
        }
